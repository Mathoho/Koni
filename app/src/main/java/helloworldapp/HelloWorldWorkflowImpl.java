...
public class HelloWorldWorkflowImpl implements HelloWorldWorkflow {
     ...
     * you have specified that the Start-to-Close Timeout for your Activity will be one minute, meaning that 
    *your Activity has one minute to begin before it times out
     */
